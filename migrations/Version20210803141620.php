...
final class Version20210803141620 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_desktop (id INT AUTO_INCREMENT NOT NULL,location_id INT DEFAULT NULL, product_id VARCHAR(255) NOT NULL, marque VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, processor VARCHAR(255) DEFAULT NULL, ram VARCHAR(255) DEFAULT NULL, hdd VARCHAR(255) DEFAULT NULL, grade VARCHAR(255) DEFAULT NULL, price NUMERIC(5, 2) DEFAULT NULL, priceb2b NUMERIC(5, 2) DEFAULT NULL, note LONGTEXT DEFAULT NULL,  INDEX IDX_D8B81E1464D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
